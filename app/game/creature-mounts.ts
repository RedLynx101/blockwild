...
export const MOUNT_PROFILES: Readonly<Record<string, MountProfile>> = Object.freeze({
  ...
  "bellstep-qilin": land(7.5, { minimumBondTier: "partnered", saddleKind: "bell-road-harness", turnRate: 2.5, mountedMoveSlots: 3, exertionCapacity: 175 }),
  "aerolith-baleen": profile({ capabilities: ["fly", "glide"], minimumBondTier: "kindred", minimumLifeStage: "adult", saddleKind: "aerolith-cradle", seats: 2, landSpeed: 0, waterSpeed: 1.2, airSpeed: 7.4, acceleration: 2.2, turnRate: .92, jumpStrength: 0, ascentRate: 3.2, descentRate: 3.8, cargoSlots: 54, mountedMoveSlots: 2, passengerRangedWeapons: true, riderBreathing: "none", exertionCapacity: 220 }),
  "mireglass-kelpie": land(7.1, { capabilities: ["land", "swim"], minimumBondTier: "partnered", saddleKind: "reedglass-tack", waterSpeed: 7.4, turnRate: 2.55, riderBreathing: "water", mountedMoveSlots: 3, exertionCapacity: 170 }),
  "cinderwing-pyrausta": profile({ capabilities: ["fly", "glide"], minimumBondTier: "partnered", minimumLifeStage: "adult", saddleKind: "emberglass-cradle", seats: 1, landSpeed: 0, waterSpeed: 0, airSpeed: 8.8, acceleration: 5.7, turnRate: 2.7, jumpStrength: 0, ascentRate: 5.2, descentRate: 5.8, cargoSlots: 0, mountedMoveSlots: 3, passengerRangedWeapons: false, riderBreathing: "none", exertionCapacity: 135 }),
  "nacre-gatewyrm": profile({ capabilities: ["swim"], minimumBondTier: "kindred", minimumLifeStage: "adult", saddleKind: "nacre-threshold", seats: 2, landSpeed: 0, waterSpeed: 8.3, airSpeed: 0, acceleration: 4.3, turnRate: 1.7, jumpStrength: 0, ascentRate: 3.5, descentRate: 4.1, cargoSlots: 27, mountedMoveSlots: 3, passengerRangedWeapons: true, riderBreathing: "water", exertionCapacity: 205 }),
  "frostcauldron-behemoth": land(4.7, { minimumBondTier: "partnered", saddleKind: "kettle-caravan", seats: 2, acceleration: 3.5, turnRate: 1.25, jumpStrength: 5.2, cargoSlots: 81, mountedMoveSlots: 2, passengerRangedWeapons: true, exertionCapacity: 240 }),
  "briarcrown-manticore": land(7, { capabilities: ["land", "glide"], minimumBondTier: "kindred", saddleKind: "root-crown-harness", airSpeed: 5.8, descentRate: 2.1, turnRate: 2.35, mountedMoveSlots: 3, exertionCapacity: 180 }),
  "tideclock-cetus": profile({ capabilities: ["swim"], minimumBondTier: "partnered", minimumLifeStage: "adult", saddleKind: "tideclock-yoke", seats: 2, landSpeed: 0, waterSpeed: 8.7, airSpeed: 0, acceleration: 3.1, turnRate: 1.15, jumpStrength: 0, ascentRate: 3.1, descentRate: 3.8, cargoSlots: 54, mountedMoveSlots: 3, passengerRangedWeapons: true, riderBreathing: "water", exertionCapacity: 230 }),
  "anemoi-gryphon": profile({ capabilities: ["land", "fly", "glide"], minimumBondTier: "kindred", minimumLifeStage: "adult", saddleKind: "nine-wind-harness", seats: 2, landSpeed: 6.4, waterSpeed: .6, airSpeed: 10.4, acceleration: 5.9, turnRate: 2.25, jumpStrength: 8.4, ascentRate: 6.1, descentRate: 6.7, cargoSlots: 27, mountedMoveSlots: 3, passengerRangedWeapons: true, riderBreathing: "none", exertionCapacity: 200 }),
  "namarra-makara": profile({ capabilities: ["land", "swim"], minimumBondTier: "kindred", minimumLifeStage: "adult", saddleKind: "pearl-court-regalia", seats: 2, landSpeed: 3.8, waterSpeed: 8.1, airSpeed: 0, acceleration: 3.8, turnRate: 1.65, jumpStrength: 4.2, ascentRate: 3.2, descentRate: 3.7, cargoSlots: 54, mountedMoveSlots: 3, passengerRangedWeapons: true, riderBreathing: "water", exertionCapacity: 220 }),
  "mycelial-oneirophant": land(4.8, { minimumBondTier: "kindred", saddleKind: "moonfelt-howdah", seats: 2, acceleration: 3.6, turnRate: 1.3, jumpStrength: 4.8, cargoSlots: 81, mountedMoveSlots: 2, passengerRangedWeapons: true, exertionCapacity: 235 }),
