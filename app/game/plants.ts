...
export const PLANTS: readonly PlantDefinition[] = Object.freeze([
  ...
  { id: "frostpear-tree", name: "Frostpear Tree", category: "tree", blocks: [BlockId.FrostpearSapling, BlockId.FrostpearLeaves, BlockId.FrostpearFruit], habitat: "Sheltered Frostpine clearings", growth: "Plant a Frostpear on living soil; the blue-green fruit returns beneath mature winter leaves.", utility: "Cold-climate orchard food and compact crate storage.", drops: [{ item: Item.Frostpear, label: "Frostpears" }] },
  { id: "wild-wheat", name: "Wild Wheat", category: "farm", blocks: [BlockId.WheatSprout, BlockId.WheatYoung, BlockId.WheatCrop], habitat: "Sparse wild patches and farmland", growth: "Fastest on tilled, hydrated soil. A scythe harvest replants it.", utility: "Mill grain into flour for bread and trail bakes, or keep it as breeding feed and a trade crop.", drops: [{ item: Item.Wheat, label: "Wheat" }, { item: Item.WheatSeeds, label: "Seeds" }] },
  ...
  { id: "brinegrass", name: "Brinegrass", category: "aquatic", blocks: [BlockId.Brinegrass], habitat: "Coastal shelves and ordinary ocean floors", growth: "Dense rooted blades form short waterlogged meadows up to two cells tall.", utility: "Primary nursery cover for fry, shellfish and small ocean creatures.", drops: [{ item: Item.BrinegrassCutting, label: "Brinegrass cuttings" }] },
  { id: "sailkelp", name: "Sailkelp", category: "aquatic", blocks: [BlockId.Sailkelp], habitat: "Ocean and deep-ocean stone shelves", growth: "Broad olive sails rise in connected waterlogged columns up to six cells tall.", utility: "Dominant vertical habitat, wet fiber and shelter for larger shoals.", drops: [{ item: Item.SailkelpFrond, label: "Sailkelp fronds" }] },
  { id: "featherwrack", name: "Featherwrack", category: "aquatic", blocks: [BlockId.Featherwrack], habitat: "Scattered coast, ocean and deep-water beds", growth: "Rust-red side branches overlap through short waterlogged colonies.", utility: "Color contrast, crustacean forage and decorative ocean planting.", drops: [{ item: Item.FeatherwrackSprig, label: "Featherwrack sprigs" }] },
  { id: "pearlfan", name: "Pearlfan", category: "aquatic", blocks: [BlockId.Pearlfan], habitat: "Rare sheltered shelves from the coast to the Lumen Trench", growth: "A pale single-cell fan spreads from a dark anchored holdfast.", utility: "A quiet non-luminous accent and future fine alchemy stock.", drops: [{ item: Item.PearlfanCutting, label: "Pearlfan cuttings" }] },
  ...
  { id: "glow-kelp", name: "Glow Kelp", category: "aquatic", blocks: [BlockId.GlowKelp], habitat: "Rare deep-ocean stands, Lumen Trench and underground water", growth: "Submerged strands draw trace minerals from stone.", utility: "Soft underwater light and aquatic cover.", drops: [{ item: BlockId.GlowKelp, label: "Glow kelp" }] },
  ...
  { id: "shellfruit", name: "Shellfruit Bed", category: "aquatic", blocks: [BlockId.ShellfruitSprout, BlockId.ShellfruitYoung, BlockId.ShellfruitCrop], habitat: "Tended ocean shelves and sheltered Lumen Trench gardens", growth: "Press a whole Shellfruit into sand, gravel, clay, mud, or stone beneath a water source. The seed-shell opens through three stages; harvesting the ripe bed leaves its young root-cluster in place.", utility: "Renewable diving provisions and reversible nine-fruit crate storage.", drops: [{ item: Item.Shellfruit, label: "Shellfruit" }] },
...
export const PLANT_NATIVE_BIOMES: Readonly<Record<string, readonly BiomeId[]>> = Object.freeze({
  ...
  "frostpear-tree": [BiomeId.Frostpine],
  ...
  brinegrass: [BiomeId.Beach, BiomeId.Ocean, BiomeId.DeepOcean],
  sailkelp: [BiomeId.Beach, BiomeId.Ocean, BiomeId.DeepOcean, BiomeId.LumenTrench],
  featherwrack: [BiomeId.Beach, BiomeId.Ocean, BiomeId.DeepOcean],
  pearlfan: [BiomeId.Beach, BiomeId.Ocean, BiomeId.DeepOcean, BiomeId.LumenTrench],
  ...
  shellfruit: [BiomeId.Ocean, BiomeId.DeepOcean, BiomeId.LumenTrench],
