...
export const LOOT_FAMILIES: Readonly<Record<LootFamilyId, LootFamily>> = Object.freeze({
  ...
  "dungeon-specialist": { id: "dungeon-specialist", aliases: ["specialist", "trap", "laboratory"], purpose: { fieldkit: [e(Item.PitonItem, 2, 5), e(Item.Rope, 2, 5), e(Item.CaveMarkerItem, 1, 3)] }, optional: [e(Item.ResonantCrystalItem, 1, 2, .3, "rare"), e(Item.LivingInk, 1, 2, .3, "rare"), e(Item.GearCluster, 1, 2, .25, "rare"), e(Item.CardforgeBooster, 1, 1, .18, "rare")], signatureItems: [Item.CaveMarkerItem, Item.PitonItem], ownership: "abandoned" },
  "dungeon-vault": { id: "dungeon-vault", aliases: ["vault", "reliquary", "boss"], purpose: { reward: [e(Item.GoldIngot, 2, 6, 1, "rare"), e(Item.CrystalShard, 2, 4, 1, "rare"), e(Item.CardforgeBooster, 1, 1, 1, "rare")] }, optional: [e(Item.PrismaticPearl, 1, 1, .35, "very-rare", "vault-prismatic-pearl", Item.LumenPearl), e(Item.NocturneHeart, 1, 1, .18, "very-rare", "vault-nocturne-heart", Item.ShadowShard), e(Item.Worldpin, 1, 1, .05, "very-rare", "vault-worldpin", Item.VeinmetalFlake)], signatureItems: [Item.GoldIngot, Item.CrystalShard, Item.CardforgeBooster], ownership: "hostile" },
