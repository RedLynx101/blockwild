...
6. `tests/visual-theme.test.ts` binds the adopted theme, reference portraits, exception registry, complete 215-creature and 286-block audit totals, movement/contact fixes, dedicated material tiles, and renderer canvas behavior into the standard release pretest.
