...
test("the fixed light pool binds to an influence volume ahead instead of the nearest source", () => {
  ...
  engine.settings = { volume: 0, muted: true, sensitivity: 0.002, fov: 72, weather: "clear", renderDistance: 5, simulationDistance: 5, showFps: false, resourceMode: "auto" } satisfies GameSettings;
